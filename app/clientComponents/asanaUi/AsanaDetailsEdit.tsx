...
export default React.memo(function AsanaDetailsEdit(
  ...
  const renderFieldInput = (field: AsanaEditFieldProps, fieldId: string) => {
    ...
    switch (field.type) {
      case 'text': {
        const textHelperMsg = field.error
        ...
        return (
          <TextField
            ...
            fullWidth
            sx={fieldSxStyles}
            helperText={textHelperMsg}
            aria-describedby={textHelperMsg ? `${fieldId}-helper` : undefined}
          />
        )
      }

      case 'multiline': {
        const mlHelperMsg = field.error
          ? field.errorText || field.helperText
          : field.helperText
        return (
          <TextField
            ...
            fullWidth
            sx={fieldSxStyles}
            helperText={mlHelperMsg}
            aria-describedby={mlHelperMsg ? `${fieldId}-helper` : undefined}
          />
        )
      }
