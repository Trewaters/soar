export abstract class TermsService {
  ...
  public static readonly IFRAMES_HEADING = 'iFrames'
  public static readonly IFRAMES_DETAILS =
    'Without prior approval and written permission, you may not create frames around our Webpages that alter in any way the visual presentation or appearance of our Website.'

  public static readonly CONTENT_LIABILITY_HEADING = 'Content Liability'
  public static readonly CONTENT_LIABILITY_DETAILS =
    'We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.'

  public static readonly PRIVACY_HEADING = 'Your Privacy'
  public static readonly PRIVACY_DETAILS = 'Please read Privacy Policy'

  public static readonly RESERVATION_RIGHTS_HEADING = 'Reservation of Rights'
  public static readonly RESERVATION_RIGHTS_DETAILS =
    'We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it&apos;s linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.'

  public static readonly LINK_REMOVAL_HEADING =
    'Removal of links from our website'
  public static readonly LINK_REMOVAL_DETAILS =
    'If you find any link on our Website that is offensive for any reason, you are free to contact and inform us any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you directly.'

  public static readonly DISCLAIMER_HEADING = 'Disclaimer'
  public static readonly DISCLAIMER_DETAILS =
