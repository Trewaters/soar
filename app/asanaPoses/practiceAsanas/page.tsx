    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <SubNavHeader
              mode={isEditMode ? 'static' : 'back'}
              link={NAV_PATHS.PRACTICE_ASANAS}
            />
            <HelpButton onClick={handleInfoClick} />
          </Stack>
          <Stack sx={{ width: '100%', maxWidth: '600px' }}>
            {/* Hide pose search while in edit mode to prevent switching poses mid-edit */}
            {!isEditMode && (
              <Box
                sx={{
                  width: '100%',
              ...
              >
                ...
                {error && (
                  <Typography sx={{ mt: 2 }}>Error: {error}</Typography>
                )}
              </Box>
            )}
          </Stack>
          ...
          >
            ...
            {selectedError && <Typography>{selectedError}</Typography>}
            {selectedPose && (
