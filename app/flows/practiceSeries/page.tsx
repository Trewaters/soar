  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SubNavHeader
            mode={editOpen ? 'static' : 'back'}
            link="/flows/practiceSeries"
          />
        ...
        <Stack sx={{ px: 4, width: '100%', maxWidth: '600px' }}>
          ...
          {/* Hide flow search while editing to prevent switching flows mid-edit */}
          {!editOpen && (
          ...
          {editOpen ? (
            ...
            >
              ...
              >
                ...
                {/* flow image - Read-only carousel display */}
                    ...
                    >
                      <Box sx={{ width: '100%', maxWidth: '500px' }}>
                        <ImageCarousel
                          ...
                          height={400}
                          showArrows={false}
                          aria-label={`${flow?.seriesName} flow image`}
                        />
                      </Box>
                    </Box>
                  </Box>
                ...
                {flow.duration && (
                  <Box sx={{ width: '100%', mt: 3 }}>
                    ...
                    <Typography variant="body1">{flow.duration}</Typography>
                  </Box>
                )}
