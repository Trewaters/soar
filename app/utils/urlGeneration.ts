...
import { SITE_URL, SITE_HOSTNAME } from '../config/site'
...
const CANONICAL_HOSTNAME = SITE_HOSTNAME.replace(/^www\./, '')
...
const CONTENT_PATHS = {
  ...
  sequence: {
    development: '/sequences/practiceSequences',
    production: '/sequences/practiceSequences',
    test: '/sequences/practiceSequences',
  },
} as const
...
export const validateUrl = (url: string): boolean => {
  try {
    ...
    if (
      urlObj.hostname.includes(CANONICAL_HOSTNAME) ||
