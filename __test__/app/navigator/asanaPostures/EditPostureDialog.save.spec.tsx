...
describe('EditPostureDialog Save', () => {
  ...
  it('saves changes and calls reorder successfully', async () => {
    ...
    const { updatePosture } = require('../../../../lib/postureService')
    updatePosture.mockResolvedValue({ id: 'pose-1' })
    ...
    // updatePosture called
    await waitFor(() => expect(updatePosture).toHaveBeenCalled())
