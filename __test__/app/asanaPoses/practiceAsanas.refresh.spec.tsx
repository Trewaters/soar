...
import PracticePage from '@app/asanaPoses/practiceAsanas/page'
...
jest.mock('next/navigation', () => ({
  ...
  usePathname: () => '/asanaPoses/practiceAsanas',
}))
...
jest.mock('@app/asanaPoses/pose-search', () => {
