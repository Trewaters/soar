...
describe('Createflow image Upload Feature', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  ...
  describe('Image Upload Functionality', () => {
    ...
    it('should display uploaded image preview', async () => {
      ...
      await waitFor(() => {
        const imagePreview = screen.getByAltText('Test flow image')
  ...
  describe('Single Image Limitation', () => {
    it('should only allow one image upload', async () => {
      ...
      // Verify the flow image is displayed
      await waitFor(() => {
        expect(screen.getByAltText('Test flow image')).toBeInTheDocument()
      })
    })
