...
describe('Share strategies', () => {
  ...
  it('SequenceShareStrategy uses canonical practiceSequences URL when data.id present', () => {
    ...
    expect(out.url).toContain('/sequences/practiceSequences?id=99')
  })
...
describe('ShareAsset component', () => {
  ...
  it('copies composed payload to clipboard when native share unavailable', async () => {
    ...
    expect(calledWith).toContain(
      '/sequences/practiceSequences?id=resolved-sequence-id'
    )
  })
