...
Visual banner displaying "Create Sequences" with an inspiring yoga practice image. Establishes the creative context for building your complete practice sessions.
...
Opens this contextual help drawer with detailed guidance on creating sequences. The green question mark icon is positioned in the top navigation area alongside the back button.

### Sequence Name (Required)

The primary identifier for your sequence. This field is required and shows a green checkmark when filled.

**Field Details:**

- Text input with placeholder "Give your Sequence a name..."
- Required field - cannot save without a name
- Success indicator (green checkmark) appears when you type
- Use descriptive names that indicate purpose or duration
...
Optional multi-line text area to add context about your sequence.

**Field Details:**

- Multi-line text input (4 rows minimum)
- Optional field with success checkmark when filled
- Placeholder: "Add an optional description for your sequence..."
- No character limit (but keep reasonable)

**What to Include:**

- Purpose or goal of the sequence
- Who it's designed for (beginners, intermediate, advanced)
- Special focus areas (flexibility, strength, relaxation)
- When to practice (morning, evening, post-workout)
- Any modifications or variations
- Duration estimate

**Example:**

> "A balanced 45-minute morning practice designed for intermediate practitioners. Focuses on building strength and flexibility through standing poses, hip openers, and gentle backbends. Perfect for starting your day with energy and focus."

### Sequence Image Upload

Optional image upload to visually represent your sequence.
...
- Remove option if you change your mind

**Image Tips:**

- Use images that represent sequence theme or energy
- Landscape orientation works best
- Clear, high-quality images create better visual appeal
- Inspirational images enhance practice motivation

### Submit and Start Over Buttons

Action bar with prominent buttons for saving or resetting your work.

**Submit Button:**

- Blue/primary color button
- Saves the sequence to your account
- Redirects to sequence detail page after success
- Disabled if not logged in
- Requires sequence name (at least)
...
- Returns to blank creation form
...
Enter a descriptive, memorable name for your sequence in the **Sequence Name** field. This is required.

**Tips:**

- Use clear, descriptive names that indicate the purpose or duration
...
2. **Name Your Sequence** (Required)
   ...
   - Click the "Give your Sequence a name..." field
   - Type a descriptive name reflecting purpose or duration
...
5. **Add Description** (Optional but Recommended)
   ...
   - Describe sequence purpose and benefits
   - Include skill level recommendations
   - Note duration and special focus areas
   - Watch for green checkmark when filled

6. **Upload Sequence Image** (Optional)

   - Drag image onto upload area or click to browse
   - Choose JPEG, PNG, or SVG (max 5MB)
   - Preview appears immediately
   - Image represents sequence visually on landing pages

7. **Submit to Save**

   - Click blue "Submit" button when ready
   - Sequence is saved to your account
   - Redirects to sequence detail page
   - You can practice or edit from there

8. **Start Over if Needed**

   - Click "Start Over" to clear all fields
   - No confirmation - clears immediately
   - Use if you want to begin again
   - Does not save any work
...
- Use duration in name for quick selection ("20-Min Core", "45-Min Full Body")
- Include focus area ("Back Pain Relief", "Hip Flexibility")
- Note difficulty level ("Beginner Gentle Flow", "Advanced Strength")
...
- State the sequence purpose clearly
- Include recommended skill level
- Note any props needed (blocks, straps, blankets)
- Mention specific benefits (stress relief, flexibility, strength)
- Add timing suggestions (morning, evening, pre-workout)

**Image Selection:**

- Choose images that match sequence energy
- Use personal photos from your practice for authenticity
- Landscape orientation displays better
- High quality images enhance visual appeal
- Consider theme or focus area representation
...
A: The "Start Over" button immediately clears all fields without confirmation. Your work is lost unless you've already saved. We recommend being careful with this button when you've invested time in building your sequence.
...
A: No, the description is optional. However, adding a description helps you remember the sequence's purpose and makes it easier for others to understand if you share it. It's especially helpful months later when revisiting old sequences.

**Q: What's the best image size for sequence images?**

A: Images up to 5MB are supported in JPEG, PNG, or SVG formats. Landscape-oriented images (wider than tall) typically display better. Choose clear, high-quality images that represent your sequence's energy or theme.

**Q: Can I create sequences without being logged in?**
